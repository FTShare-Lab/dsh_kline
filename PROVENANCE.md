...
under `view/` and compiled into the native DSH sidebar. The browser code was
adapted to same-origin session APIs; its MCP Apps handshake and original host
runtime dependency were removed.
