"""Provider-neutral metric application service.

The compatibility module in ``tools.calc`` forwards here so the domain layer
does not depend on the historical tools package.
"""
